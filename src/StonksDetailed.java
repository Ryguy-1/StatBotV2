...
///////////////////////	
	...
	private void formatResponse() {
		...
		try {
			...
			try{this.ftWeekHigh = obj2.getDouble("52WeekHigh");}catch(Exception e) {this.ftWeekHigh = 0;}
			try{this.ftWeekLow = obj2.getDouble("52WeekLow");}catch(Exception e) {this.ftWeekLow = 0;}
			try{this.ftWeekPriceReturnDaily = obj2.getDouble("52WeekPriceReturnDaily");}catch(Exception e) {this.ftWeekPriceReturnDaily = 0;}
			try{this.fiveDayPriceReturnDaily = obj2.getDouble("5DayPriceReturnDaily");}catch(Exception e) {this.fiveDayPriceReturnDaily = 0;}
			try{this.dividendYieldIndicatedAnnual = obj2.getDouble("dividendYieldIndicatedAnnual");}catch(Exception e) {this.dividendYieldIndicatedAnnual = 0;}
			try{this.currentEvOverFreeCashFlowAnnual = obj2.getDouble("currentEv/freeCashFlowAnnual");}catch(Exception e) {this.currentEvOverFreeCashFlowAnnual = 0;}
			try{this.epsGrowth3Y = obj2.getDouble("epsGrowth3Y");}catch(Exception e) {this.epsGrowth3Y = 0;}
			try{this.epsGrowth5Y = obj2.getDouble("epsGrowth5Y");}catch(Exception e) {this.epsGrowth5Y = 0;}
			try{this.epsGrowthTTMYoy = obj2.getDouble("epsGrowthTTMYoy");}catch(Exception e) {this.epsGrowthTTMYoy = 0;}
			//if doesn't have market cap won't show any information here... This is to show you when you've entered a wrong ticker
			this.marketCapitalizationInMillions = obj2.getDouble("marketCapitalization");
			try{this.operatingMargin5Y = obj2.getDouble("operatingMargin5Y");}catch(Exception e) {this.operatingMargin5Y = 0;}
			try{this.operatingMarginAnnual = obj2.getDouble("operatingMarginAnnual");}catch(Exception e) {this.operatingMarginAnnual = 0;}
			try{this.peBasicExclExtraTTM = obj2.getDouble("peBasicExclExtraTTM");}catch(Exception e) {this.peBasicExclExtraTTM = 0;}
			try{this.priceRelativeToSandP50052Week = obj2.getDouble("priceRelativeToS&P50052Week");}catch(Exception e) {this.priceRelativeToSandP50052Week = 0;}
			try{this.revenueGrowth3Y = obj2.getDouble("revenueGrowth3Y");}catch(Exception e) {this.revenueGrowth3Y = 0;}
			try{this.revenueGrowth5Y = obj2.getDouble("revenueGrowth5Y");}catch(Exception e) {this.revenueGrowth5Y = 0;}
			try{this.revenueGrowthTTMYoy = obj2.getDouble("revenueGrowthTTMYoy");}catch(Exception e) {this.revenueGrowthTTMYoy = 0;}
